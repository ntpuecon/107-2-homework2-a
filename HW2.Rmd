...
$$E(y_i|x,\tilde{w_i})=\beta^*E(x_i|x_i,\tilde{w_i})+{\gamma}E(\tilde{w_i}|x_i,\tilde{w_i})-{\gamma}E({\epsilon}|x_i,\tilde{w_i})+E(y_{-x,-w,i}|x_i,w_i)$$
$$=\beta^*x_i+\gamma\tilde{w_i}-{\gamma}E({\epsilon}|x_i,\tilde{w_i})+E(y_{-x,-w,i}|x_i,w_i)$$
